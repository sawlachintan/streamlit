...
if submitted:
    if bat_team == bowl:
        ...
        st.write(f"# **Predicted runs are: {score_predict(batting_team=bat_team, bowling_team=bowl, runs=runs, wickets=wickets, overs=str_format(
            overs_slider), runs_last_5=last5_rus, wickets_last_5=last5_wickets, fours=fours, sixes=sixes, city=city)}**")
